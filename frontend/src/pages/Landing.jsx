...
const features = [
  {
    ...
    desc: "Crystal clear video with up to 100 participants in one call.",
  },
  {
    icon: "💬",
    title: "Live Chat",
    desc: "Send messages, links, and files during your meeting.",
  },
  {
    icon: "🖐",
    title: "Hand Raise Queue",
    desc: "Orderly participation with a built-in hand raise system.",
  },
  {
    icon: "📋",
    title: "Meeting History",
    desc: "Review past meetings, attendance logs, and recordings.",
  },
];
    ...
    <div style={{
      ...
      <section style={{
        ...
        <div style={{
          ...
          background: "#e8f0fe", borderRadius: 100,
        ...
        <p style={{
          ...
          Connect, collaborate, and celebrate from anywhere with Collab — secure,
          reliable video meetings for everyone.
        </p>
        ...
        <div style={{ display: "flex", gap: 16, flexWrap: "wrap", justifyContent: "center" }}>
          <button
            ...
            onMouseEnter={e => { e.target.style.background = "#1557b0"; e.target.style.transform = "translateY(-1px)"; }}
          ...
          <button
            ...
            style={{
              padding: "14px 32px", borderRadius: 8,
              border: "1px solid #dadce0", background: "#fff",
              color: "#202124", fontWeight: 600, fontSize: 16,
              cursor: "pointer", transition: "background 0.2s, transform 0.1s",
            }}
            onMouseEnter={e => { e.target.style.background = "#f1f3f4"; e.target.style.transform = "translateY(-1px)"; }}
      ...
      <section style={{
        ...
        <div style={{
          ...
          {["Alex K.", "Maria S.", "James T.", "You"].map((name, i) => (
            <div key={i} style={{
              background: i === 3 ? "#e8f0fe" : ["#202124", "#3c4043", "#1a73e8", "#137333"][i],
              borderRadius: 12,
              display: "flex", flexDirection: "column",
              alignItems: "center", justifyContent: "center",
              minHeight: 100, gap: 8, position: "relative",
            }}>
              <div style={{
                width: 48, height: 48, borderRadius: "50%",
                background: i === 3 ? "#1a73e8" : "rgba(255,255,255,0.2)",
                display: "flex", alignItems: "center", justifyContent: "center",
              ...
              <span style={{
                ...
                color: i === 3 ? "#1a73e8" : "rgba(255,255,255,0.9)",
              }}>{name}</span>
              {i === 0 && (
                <div style={{
                  position: "absolute", bottom: 8, left: 8,
                  background: "#ea4335", borderRadius: 4,
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 960, margin: "0 auto" }}>
          <h2 style={{
            ...
            fontWeight: 700, marginBottom: 8, color: "#202124",
          }}>
      ...
      <section style={{
        ...
        <h2 style={{ fontSize: 32, fontWeight: 700, marginBottom: 16, color: "#202124" }}>
          Ready to meet?
        </h2>
        <p style={{ color: "#5f6368", fontSize: 16, marginBottom: 32 }}>
          Join thousands of teams already using Collab.
        </p>
        <button
          onClick={() => navigate("/signup")}
          style={{
