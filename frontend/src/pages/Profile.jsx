...
export default function Profile() {
  ...
  const saveEmailPrefs = async () => {
    ...
    setSaving(true);
    try {
      const res = await fetch(`${API}/api/profile/email-prefs`, {
        method: "PUT",
        headers: { "Content-Type": "application/json", Authorization: `Bearer ${token}` },
  ...
  return (
    <div style={s.root}>
      ...
      {/* Toast */}
      {toast && (
        <div style={{ ...s.toast, background: toast.type === "error" ? "#dc2626" : "#10b981" }}>
      ...
      <main style={s.main}>
        ...
        {activeTab === "general" && (
          <div style={s.card}>
            ...
            <div style={s.avatarRow}>
              <div style={s.avatarWrap}>
                {avatar
                  ...
                  : <div style={s.avatarFallback}>{name?.[0]?.toUpperCase() || "U"}</div>
                }
            ...
            <button onClick={saveGeneral} disabled={saving} style={s.saveBtn}>
        ...
        {activeTab === "password" && (
          <div style={s.card}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "16px", maxWidth: "420px" }}>
              <div style={s.fieldGroup}>
                ...
                <input type="password" value={currentPw} onChange={(e) => setCurrentPw(e.target.value)}
                  style={s.input} placeholder="Enter current password" />
              </div>
              <div style={s.fieldGroup}>
                <label style={s.label}>New Password</label>
                <input type="password" value={newPw} onChange={(e) => setNewPw(e.target.value)}
                  style={s.input} placeholder="Enter new password" />
              </div>
              <div style={s.fieldGroup}>
                ...
                {newPw && confirmPw && (
                  <span style={{ fontSize: "0.78rem", color: newPw === confirmPw ? "#10b981" : "#dc2626", marginTop: "4px" }}>
            ...
            <button onClick={savePassword} disabled={saving || !currentPw || !newPw || !confirmPw} style={{ ...s.saveBtn, opacity: (!currentPw || !newPw || !confirmPw) ? 0.5 : 1 }}>
        ...
        {activeTab === "email" && (
          <div style={s.card}>
              ...
              {[
                ...
                <div key={pref.key} style={{ ...s.prefRow, borderTop: i === 0 ? "none" : "1px solid #f1f5f9" }}>
                  ...
                  <div
                    ...
                    style={{ ...s.toggle, background: emailPrefs[pref.key] ? "#6C63FF" : "#e2e8f0" }}
                  >
            ...
            <button onClick={saveEmailPrefs} disabled={saving} style={s.saveBtn}>
